...
# Mouse Click Section
#############################
async def crawl_google_ref_click(seed_url, url_index):
    referrer = util_def.GOOGLE_REF
    action = util_def.MOUSE_CLICK
...
async def crawl_facebook_ref_click(seed_url, url_index):
    referrer = util_def.FACEBOOK_REF
    action = util_def.MOUSE_CLICK
    print(f"------------------------------\nConfigurations:\nUser-Agent: Windows User\nReferrer: Facebook\nUser interaction: Left Click\nCurrent Url #: {url_index}\n------------------------------")
    await crawler.crawl(device_conf=util_def.WINDOWS, ref_flag=referrer, act_flag=action, url=seed_url, index=url_index)
...
async def crawl_self_ref_click(seed_url, url_index):
    referrer = util_def.SELF_REF
    action = util_def.MOUSE_CLICK
    print(f"------------------------------\nConfigurations:\nUser-Agent: Windows User\nReferrer: Self\nUser interaction: Left Click\nCurrent Url #: {url_index}\n------------------------------")
    await crawler.crawl(device_conf=util_def.WINDOWS, ref_flag=referrer, act_flag=action, url=seed_url, index=url_index)
...
async def crawl_no_ref_click(seed_url, url_index):
    referrer = util_def.NO_REF
    action = util_def.MOUSE_CLICK
    print(f"------------------------------\nConfigurations:\nUser-Agent: Windows User\nReferrer: None\nUser interaction: Left Click\nCurrent Url #: {url_index}\n------------------------------")
    await crawler.crawl(device_conf=util_def.WINDOWS, ref_flag=referrer, act_flag=action, url=seed_url, index=url_index)
...
def analyze_windows_config_data():
    ...
    analyzer.extract_and_analyse(util_def.WINDOWS, ref_flag=util_def.GOOGLE_REF, act_flag=util_def.MOUSE_CLICK)
    analyzer.extract_and_analyse(util_def.WINDOWS, ref_flag=util_def.SELF_REF, act_flag=util_def.MOUSE_CLICK)
    analyzer.extract_and_analyse(util_def.WINDOWS, ref_flag=util_def.FACEBOOK_REF, act_flag=util_def.MOUSE_CLICK)
    analyzer.extract_and_analyse(util_def.WINDOWS, ref_flag=util_def.NO_REF, act_flag=util_def.MOUSE_CLICK)
...
def analyze_mac_config_data():
    ...
    analyzer.extract_and_analyse(util_def.MAC, ref_flag=util_def.GOOGLE_REF, act_flag=util_def.MOUSE_CLICK)
    analyzer.extract_and_analyse(util_def.MAC, ref_flag=util_def.SELF_REF, act_flag=util_def.MOUSE_CLICK)
    analyzer.extract_and_analyse(util_def.MAC, ref_flag=util_def.FACEBOOK_REF, act_flag=util_def.MOUSE_CLICK)
    analyzer.extract_and_analyse(util_def.MAC, ref_flag=util_def.NO_REF, act_flag=util_def.MOUSE_CLICK)
...
def analyze_bot_config_data():
    ...
    analyzer.extract_and_analyse(util_def.BOT, ref_flag=util_def.GOOGLE_REF, act_flag=util_def.MOUSE_CLICK)
    analyzer.extract_and_analyse(util_def.BOT, ref_flag=util_def.SELF_REF, act_flag=util_def.MOUSE_CLICK)
    analyzer.extract_and_analyse(util_def.BOT, ref_flag=util_def.FACEBOOK_REF, act_flag=util_def.MOUSE_CLICK)
    analyzer.extract_and_analyse(util_def.BOT, ref_flag=util_def.NO_REF, act_flag=util_def.MOUSE_CLICK)
...
async def start_program(seed_url_list):
    ...
    for url in seed_url_list:
        ...
        await crawl_self_ref_click(url, url_index)
        await crawl_google_ref_click(url, url_index)
        await crawl_no_ref_click(url, url_index)
        await crawl_facebook_ref_click(url, url_index)
...
async def main():
    feeds = read_feeds_from_file("feeds/phishing_feeds_150923_2.txt")
