...
def get_server_side_data(device_conf, ref_flag, act_flag, browser, folder_path, actual_url):
    ...
    page, _, referrer = setup_crawler_context(ref_flag, browser, folder_path)
    if ref_flag:
...
def scrape_one_level_deeper(device_conf, ref_flag, act_flag, browser, embedded_path, referrer, base_index, error_list):
...
def get_dataset(device_conf, ref_flag, act_flag, browser, url_list):
