...
def consolidate_dns_into_single_excel(ref):
    ...
    for sub_folder in sub_folders:
        dns_filepath = os.path.join(dataset_path, sub_folder, util_def.FILE_DNS)
    ...
    output_path = os.path.join(util_def.FOLDER_ANALYSIS_BASE, ref, util_def.EXCEL_DNS_CONSOLIDATED)
...
def generate_consolidated_dns_summary_report(ref):
    data_path = os.path.join(util_def.FOLDER_ANALYSIS_BASE, ref, util_def.EXCEL_DNS_CONSOLIDATED)
